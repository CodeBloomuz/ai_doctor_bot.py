...
# ═══════════════════════════════════════════════
#  SOZLAMALAR — BU YERGA O'Z TOKENLARINGIZNI KIRITING
# ═══════════════════════════════════════════════
BOT_TOKEN = "BU_YERGA_BOT_TOKENINI_KO'CHING"          # @BotFather dan olinadi
ANTHROPIC_API_KEY = "BU_YERGA_ANTHROPIC_API_KEYni_KO'CHING"  # console.anthropic.com dan
